...
<preview path="../demo/Form/Inspection.vue" title="典型表单" description="Form 典型表单"></preview>

## 自定义校验规则

这个例子中展示了如何使用自定义验证规则来完成密码的二次验证

<preview path="../demo/Form/CustomValidation.vue" title="典型表单" description="Form 典型表单"></preview>
