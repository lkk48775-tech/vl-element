...
<preview path="../demo/Alert/basics.vue" title="基础用法" description="Button 组件的基础用法"></preview>
...
<preview path="../demo/Alert/noClose.vue" title="基础用法" description="Button 组件的基础用法"></preview>
...
| 属性名 | 说明 | 类型 | 默认值 |
|--------|------|------|--------|
| type | 类型 | `'success' ， 'warning' ， 'danger' ， 'info'` | `info` |
